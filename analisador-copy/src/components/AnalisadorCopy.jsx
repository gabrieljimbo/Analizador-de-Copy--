/**
 * ============================================================
 * ANALISADOR DE COPY COM IA — v2.1 (N8N ONLY)
 * ============================================================
 *
 * ✅ Agora puxa 100% do n8n via webhook (sem modo direto).
 *
...
async function safeReadJson(response) {
    ...
    // Se não vier JSON, tenta ler texto e jogar erro com snippet
    if (!ct.includes("application/json")) {
        const txt = await response.text().catch(() => "");
        throw new Error(`Resposta não-JSON do n8n. Content-Type: ${ct}. Body: ${txt.slice(0, 300)}`);
    }
...
export default function AnalisadorCopy() {
    ...
    const analisar = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                // tenta extrair corpo pra debugar
            ...
            // Salva retorno completo para a aba 2
            setN8nData(normalized.raw);
                                ...
                                <div className="cards-grid">
                                    ...
                                    <div className="card">
                                        <div className="card-header">
                                            <div className="card-icon" style={{ background: "rgba(0,150,255,0.1)" }}>
                                                🔍
                                            </div>
                                            <div>
                                        ...
                                        <div className="mini-bar">
                                            <div
                                                ...
                                                style={{ width: `${analise.clareza.score}%`, background: getScoreColor(analise.clareza.score) }}
                                            />
                                        </div>
                                    ...
                                    <div className="card">
                                        <div className="card-header">
                                            <div className="card-icon" style={{ background: "rgba(255,77,0,0.1)" }}>
                                                ⚡
                                            </div>
                                            <div>
                                                ...
                                                <div
                                                    ...
                                                    style={{ color: getScoreColor(analise.gatilhos_emocionais.score) }}
                                                >
                                    ...
                                    <div className="card">
                                        <div className="card-header">
                                            <div className="card-icon" style={{ background: "rgba(255,215,0,0.1)" }}>
                                                🎯
                                            </div>
                                            <div>
                                    ...
                                    <div className="card">
                                        <div className="card-header">
                                            <div className="card-icon" style={{ background: "rgba(0,255,135,0.1)" }}>
                                                🛡️
                                            </div>
                                            <div>
                                    ...
                                    <div className="card">
                                        <div className="card-header">
                                            <div className="card-icon" style={{ background: "rgba(150,0,255,0.1)" }}>
                                                💎
                                            </div>
                                            <div>
                                        ...
                                        <div className="mini-bar">
                                            <div
                                                className="mini-bar-fill"
                                                style={{
                                                    width: `${analise.proposta_valor.score}%`,
                                                    background: getScoreColor(analise.proposta_valor.score),
                                                }}
                                            />
                                        </div>
                                    ...
                                    <div className="card rewrite-card">
                                        <div className="card-header">
                                            <div className="card-icon" style={{ background: "rgba(255,77,0,0.15)" }}>
                                                ✍️
                                            </div>
                                    ...
                                    <div className="card card-full">
                                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                                                ...
                                                <ul className="list-items">
                                                    {analise.pontos_fortes?.map((p, i) => (
                                                        <li key={i} className="list-item">
                                                            <span className="list-item-icon" style={{ color: "#00ff87" }}>
                                                                →
                                                            </span>
                                                            {p}
                                                        </li>
                                            ...
                                            <div>
                                                <div className="card-header">
                                                    <div className="card-icon" style={{ background: "rgba(255,61,87,0.1)" }}>
                                                        ⚠️
                                                    </div>
                                                ...
                                                <ul className="list-items">
                                                    {analise.pontos_criticos?.map((p, i) => (
                                                        <li key={i} className="list-item">
                                                            <span className="list-item-icon" style={{ color: "#ff3d57" }}>
                                                                →
                                                            </span>
                                                            {p}
                                                        </li>
                                        ...
                                        {variacoes.length > 0 && (
                                            <>
                                                <div className="section-label">
                                                    {variacoes.length} variação{variacoes.length > 1 ? "ões" : ""} gerada
                                                    {variacoes.length > 1 ? "s" : ""}
                                                </div>
                                                ...
                                                {variacoes.map((v, idx) => (
                                                    <div key={idx} className="variacao-card">
                                                        <div className="variacao-header">
                                                            ...
                                                            <button className="copy-variacao-btn" onClick={() => copiarVariacao(v.copy || "", idx)}>
